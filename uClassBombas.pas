...
begin
  ...
  fdmConect.fdqQryBomba.Sql.Add(' select b.idBomba, b.descricao, b.idTanque || '' - '' || t.descricao as TANQUE ');
  fdmConect.fdqQryBomba.Sql.Add('   from bomba b ');
  fdmConect.fdqQryBomba.Sql.Add('  inner join tanque t on t.idTanque = b.idTanque ');
